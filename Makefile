...
jvm: ${SRC_DIR}/Compiler/JVM.hs
	ghc ${SRC_DIR}/Compiler/JVM.hs -package mtl -i${SRC_DIR}/Compiler -i${SRC_DIR} -outputdir ${BUILD_DIR} -o insc_jvm
	
llvm: ${SRC_DIR}/Compiler/LLVM.hs
	ghc ${SRC_DIR}/Compiler/LLVM.hs -package mtl -i${SRC_DIR}/Compiler -i${SRC_DIR} -outputdir ${BUILD_DIR} -o insc_llvm
